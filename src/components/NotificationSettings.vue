    ...
    <div class="benchmark-modal">
        <div class="benchmark-modal-content">
            ...
            <div id="benchmark-button-selection-wrapper">
                <div v-for="(button, index) in buttons" :key="index" @click="toggleSettingsType(button.type)"
                    :class="{ 'benchmark-selection-button': true, 'benchmark-active': selectedSettingsType === button.type }">
                    {{ button.label }}
                </div>
            </div>
            ...
            <div class="benchmark-input-wrapper">
                <div class="input-with-button">
                    ...
                    <div class="input-container">
                        <input v-if="selectedSettingsType === 'email'" type="text" class="input-field" placeholder="example@test.com" />
                        <input v-if="selectedSettingsType === 'phone'" type="tel" class="input-field" placeholder="02439182738" />
                        ...
                        <div class="benchmark-noti">
                            <div v-for="notification in notifications" :key="notification.id">
                                <div class="benchmark-radio-wrapper"
                                    ...
                                    <input class="benchmark-radio" type="radio" :name="notification.name"
                                        :id="notification.id" v-model="selectedNotificationId"
                        ...
                        <div class="benchmark-noti grid">
                            <div class="benchmark-grid">
                                ...
                                <div v-for="report in reports" :key="report.id">
                                    <div class="benchmark-checkbox-wrapper" :class="{
                    'benchmark-checkbox-wrapper-active': report.checked,
                }">
                                        <input class="benchmark-checkbox" type="checkbox" :name="report.name"
                                            :id="report.id" v-model="report.checked" />
                                        <label class="benchmark-checkbox-label" :for="report.id">{{ report.label
                                            }}</label>
                                    </div>
                                </div>
                            </div>
